...
- Civic311 v0.1.0 must not call live LLMs or live 311/work-order systems.
...
- Civic311 may reference CivicAccess and CivicCode concepts only through released APIs or deterministic sample data in v0.1.0.
